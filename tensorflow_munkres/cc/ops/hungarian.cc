...
class HungarianOpCPU : public OpKernel {
 public:
  explicit HungarianOpCPU(OpKernelConstruction* context) : OpKernel(context) {}
...
//TODO: add error handling for inf or input with overflow
class HungarianOpGPU : public OpKernel {
 public:
  explicit HungarianOpGPU(OpKernelConstruction* context) : OpKernel(context) {}
...
REGISTER_KERNEL_BUILDER(Name("Hungarian").Device(DEVICE_CPU), HungarianOpCPU);
